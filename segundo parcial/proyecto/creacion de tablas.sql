...
create table CITA (
   ...
   ID_CLIENTE_UNO       INT4                 null,
   ID_CLIENTE_DOS       INT4                 null,
...
create table PREFERENCIAS_PERSONALES (
   ...
   constraint PK_PREFERENCIAS_PERSONALES primary key (ID_PERSONAL)
);

/*==============================================================*/
/* Index: INFORMACION_PERSONAL_PK                               */
/*==============================================================*/
create unique index INFORMACION_PERSONAL_PK on PREFERENCIAS_PERSONALES (
ID_PERSONAL
);
...
/* Index: TIENE_FK                                              */
/*==============================================================*/
create  index TIENE_FK on PREFERENCIAS_PERSONALES (
ID_CLIENTE
);
...
alter table CITA
   add constraint FK_CITA_ACOJE_CLIENTE foreign key (ID_CLIENTE_DOS)
...
alter table CITA
   add constraint FK_CITA_EMPAREJA_CLIENTE foreign key (ID_CLIENTE_UNO)
      references CLIENTE (ID_CLIENTE)
      on delete restrict on update restrict;
...
alter table PREFERENCIAS_PERSONALES
   add constraint FK_PREFEREN_TIENE_CLIENTE foreign key (ID_CLIENTE)
      references CLIENTE (ID_CLIENTE)
      on delete restrict on update restrict;
