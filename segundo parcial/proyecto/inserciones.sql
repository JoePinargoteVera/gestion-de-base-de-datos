...
/*==============================================================*/
insert into preferencias_personales (gusto_personal,disgusto_personal,descricion_personal,id_cliente)
...
insert into cita (estado_cita, tiempo_cita, fecha_cita, calificacion_cita, id_cliente_uno,id_cliente_dos,id_medios_relacion,id_sector_cita)
	values	('realizado','02:00','10-05-2022','buena',1,2,1,1),		
		('realizado','02:00','01-03-2022','regular',7,8,4,1),
		('realizado','01:00','16-12-2021','mala',3,9,3,2),
		('realizado','01:30','19-10-2021','regular',4,12,6,3),
		('realizado','02:30','23-08-2020','buena',5,10,5,2),
		('realizado','03:00','08-06-2020','buena',6,11,5,5);
